...
namespace GoldenCityShop.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_FeedController : GoldenCityShop.Controllers.FeedController
    {
        public T4MVC_FeedController() : base(Dummy.Instance) { }

        [NonAction]
        partial void ProductOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult Product()
        {
